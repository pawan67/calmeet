...
const features = [
  {
    ...
    description: "Calmeet is Your Scheduling Savior",
    href: "/",
    cta: "Learn more",
  ...
  },
  {
    Icon: InputIcon,
    name: "Fun",
    description: "Finally, Scheduling Made Fun (Yes, Really!)",
    href: "/",
    cta: "Learn more",
  ...
  {
    Icon: GlobeIcon,
    name: "Globaly supported",
    description: "Book from anywhere in the world.",
    href: "/",
    cta: "Learn more",
    className: "col-span-3 lg:col-span-2",
    background: (
  ...
  },
  {
    Icon: CalendarIcon,
    name: "Calendar",
    description: "Nice calendar to book your meetings.",
    className: "col-span-3 lg:col-span-1",
    href: "/",
    cta: "Learn more",
    background: (
